...
module Purpleline
  class Application < Rails::Application
    ...
    config.action_view.javascript_expansions[:defaults] = %w(jquery jquery-ui rails highcharts highcharts-theme  s3Slider  facebox jquery.marquee jquery.lightbox-0.5 )
