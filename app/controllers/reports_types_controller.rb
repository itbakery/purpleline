class ReportsTypesController < ApplicationController
  # GET /reports_types
  ...
  def create
    ...
    respond_to do |format|
      if @reports_type.save
        format.html { redirect_to(@reports_type, :notice => 'Reports type was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @reports_type.update_attributes(params[:reports_type])
        format.html { redirect_to(@reports_type, :notice => 'Reports type was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(reports_types_url) }
      format.xml  { head :ok }
    end
  end
end
