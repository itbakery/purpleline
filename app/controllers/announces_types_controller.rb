class AnnouncesTypesController < ApplicationController
  # GET /announces_types
  ...
  def create
    ...
    respond_to do |format|
      if @announces_type.save
        format.html { redirect_to(@announces_type, :notice => 'Announces type was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @announces_type.update_attributes(params[:announces_type])
        format.html { redirect_to(@announces_type, :notice => 'Announces type was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(announces_types_url) }
      format.xml  { head :ok }
    end
  end
end
